      ...
      <div className="grade-distribution">
        <div className="grade-bars">
          {Object.entries(distribution).map(([grade, percentage]) => {
            const width =
              total > 0 ? (parseInt(percentage || 0) / total) * 100 : 0;
            const colors = {
              A: "#10b981",
              B: "#3b82f6",
              C: "#f59e0b",
      ...
      <div className="report-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="report-header">
          <div className="report-title-section">
            <h1 className="report-course-code">
              {report.metadata?.courseCode}
            </h1>
            <h2 className="report-course-name">
              {report.metadata?.courseName}
            </h2>
        ...
        <div className="report-content">
              ...
              <div className="difficulty-card">
                ...
                <div className="workload-display">
                  <span className="workload-hours">
                    {report.difficulty?.workloadHours}
                  </span>
          ...
          <Section title="Course Statistics" icon="📈">
              ...
              <div className="stat-card">
                ...
                <div className="popularity-score">
                  <span className="score-value">
                    {report.statistics?.popularityScore}/10
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grade-distribution-section">
              ...
              <GradeDistributionChart
                distribution={report.statistics?.averageGradeDistribution}
              />
            </div>
          </Section>
          ...
          <Section title="Career Prospects" icon="💼">
            <div className="career-header">
              ...
              <CareerRelevanceMeter
                rating={report.careerProspects?.industryRelevance}
              />
            </div>
          ...
          <div className="report-footer">
            <div className="generation-info">
              <p>
                ...
                {report.cached &&
                  report.cacheAge &&
                  ` • Cached ${report.cacheAge} minutes ago`}
              </p>
